...
IDiskQueue* openDiskQueue( std::string basename, std::string fileExtension, UID dbgid, int64_t fileSizeWarningLimit = -1 );  // opens basename+"0.fileExtension" and basename+"1.fileExtension"
